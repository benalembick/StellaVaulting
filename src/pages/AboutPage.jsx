  ...
  return (
    <div className="pt-20">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 text-center">
        ...
        <h1 className="font-serif text-5xl md:text-6xl text-brand-white font-light">About Us</h1>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="relative">
              <div className="aspect-square bg-brand-gold/5 rounded-lg border border-brand-gold/20 flex items-center justify-center">
                <div className="text-center text-brand-gold/30">
                  <div className="text-8xl font-serif">✦</div>
                  <p className="text-sm mt-4 text-brand-white/30 tracking-wider uppercase">Stella Vaulting</p>
                </div>
              </div>
              <div className="absolute -bottom-4 -right-4 w-32 h-32 border border-brand-gold/20 rounded-lg" />
            </div>
          </div>

          {/* Values */}
          <div className="py-16 border-t border-brand-gold/20">
            <SectionHeading label="What Drives Us" title="Our Values" center className="mb-12" />
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={label} className="pink-panel p-6 text-center">
                  <div className="text-3xl mb-3">{icon}</div>
                  <h3 className="font-serif text-lg text-brand-white mb-2">{label}</h3>
